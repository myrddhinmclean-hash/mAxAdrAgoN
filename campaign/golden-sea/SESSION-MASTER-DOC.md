...
29. **Scope-Leak in W16.0 Staging (CLOSED):** W16.0 staging sweep inadvertently included uncommitted voice refactor edits from the working tree (including non-campaign file `content/draega/druids-temple-shell-valley.md`). Root cause: staging uncommitted working tree residue without per-file scope verification. Reverted draega file to prior state; verified Golden Sea module residue against Rulings 1–41.
