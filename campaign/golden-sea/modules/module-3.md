---
session: "3"
title: "The Kladesh Ocean, the Waveborn Parley, and Thalassar"
act: "I"
level: 3
party_size: 4
...
# The Kladesh Ocean, the Waveborn Parley, and Thalassar
...
1. **The Bounty (rewritten as The Salvage Accord).** The waveborn chieftain offers safe escort through the reef maze in exchange for the iron fittings and weapons in the Empire ship's armory. Discovery: **DC 13 Charisma (Persuasion)** during the parley.
2. **The Distress Call (rewritten as The Drowning Crew).** Three Empire sailors are trapped in the flooding lower steerage; rescuing them yields a navigation chart of the Thalassar approaches. Discovery: **DC 10 Strength (Athletics)** to clear the hatch.
3. **The Unsealed Ruin (rewritten as The Waveborn Shrine).** An offshore reef shrine near Thalassar marks the boundary of waveborn territory, radiating ancient abjuration magic.
4. **The Direct Ambush (rewritten as The Harbor Watch).** Empire customs enforcers at Thalassar's outer tidal gate attempt to detain incoming vessels lacking regional quarantine permits.
...
### Area 1: Deck of the *Tide of Froscius* (The Oceanic Centerpiece)
...
* **Dimensions and Environment:** Three miles of jagged black coral reefs separating the Kladesh shelf from Thalassar bay.
* **Environmental Navigation Hazard:** Navigating the shallows with the waveborn escort requires keen observation. The party assists in sounding the depths (**DC 12 Wisdom (Perception)** or **Intelligence (Nature)** check to avoid coral ridges).

### Area 3: Thalassar Tidal Docks (Social & Puzzle Hub)
* **Dimensions and Environment:** Expansive granite piers and submerged wooden ramps where dock buildings sit on twenty-foot stone stilts above the crashing tide.
* **The Tidal Clock:** The outgoing tide is rapidly draining the harbor basin. The party has a strict window to locate Cpt. T, transfer their gear and ITEM X strongbox, and clear the harbor locks.
* **The Reunion & Negotiation:** Meeting Cpt. T at the *Salty Lantern* dockhouse. Cpt. T agrees to transport the party to Braaken but requires the party to secure clearance through the harbormaster's lock gate.

### Area 4: Outer Harbor Channel (The Departure)
* **Dimensions and Environment:** Deep-water channel leading out into the coastal current toward Braaken.
* **Deploying W3 (The Ship-Hider):**
  * As Cpt. T's fishing vessel slips into the main channel beneath the gaze of Empire watchtowers, the party drapes the treated canvas of W3 over the deck cargo and cabin roof.
  * The magic of W3 ripples outward, disguising the vessel as a battered kelp harvester, allowing it to clear the outer roadstead unchallenged.
...
* **Cpt. T (Captain Trident)** (water genasi, she/her, rebel boat captain)
  * *Drive:* Re-establish supply lines to Braaken and pilot her boat safely across the southern bay. Has AC 13, HP 22.
* **Empire Sailors & Marines** (panicked crew of the *Tide of Froscius*)
  * *Drive:* Survive the shipwreck and surrender salvage rights to avoid drowning.

---

## 6. Encounter Math Breakdown

* **Encounter 1 (Area 1, Waveborn Deck Clash & Parley):** 4 Waveborn Warriors (400 XP) + 4 Skirmishers (200 XP). Parley conversion resolves the encounter: Award **600 XP** (Hard encounter for four Level 3 characters).
* **Encounter 2 (Area 2, Reef Labyrinth Navigation):** Environmental navigation check (Tier 1 hazard, DC 12). 100 XP (Easy).
* **Encounter 3 (Area 3 & 4, Thalassar Tidal Clock & W3 Departure):** Social negotiation and timed puzzle resolution. 250 XP (Easy).
* **Day Total:** 950 XP, well within the 4,800 XP daily budget for Level 3.

---

## 7. Concrete Rewards and Magic Items

* **Coin Hoard:** 35 gp from Cpt. T's supplies + 20 gp salvage value. Total: 55 gp.
* **Consumable Item:** Potion of Water Breathing (Uncommon). 1 potion gifted by Kaelen following the parley.
* **Active Boon Deployment:** **W1 (Tide-Walker Disc)** demonstrated in full view of the party; **W3 (Ship-Hider)** actively deployed to camouflage the departure vessel.
...
* **Claim:** Module-3 covers Session 7 (Day 15 at Kladesh Ocean and Thalassar landfall). Days 10 to 14 are open-water transit with zero scripted encounters per the Breathing Rule (Ruling 19).
...
* **Claim:** Thalassar replaces port city AZ and features a waveborn quarter with twice-daily tidal causeways that create a natural departure clock.
* **Status:** Canon per Ruling 18.

### Entry 4 — Pursuit Thread Relaxation
* **Claim:** The *Iron Fortress* pursuit thread formally relaxes during oceanic transit, as the party is beyond regional patrol jurisdiction. Pursuit pressure shifts to naval concentration rumors surrounding Braaken.
* **Status:** Logged assumption connecting Act I to Act II.
